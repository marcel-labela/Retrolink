...
function asBaseComponent(WrappedComponent, options = {}) {
  class BaseComponent extends UIComponent {
    ...
    render() {
      ...
      const modifiers = options.ignoreModifiers ? EMPTY_MODIFIERS : Modifiers.generateModifiersStyle(options.modifiersOptions, themeProps); // TODO: omit original modifiers props (left, right, flex, etc..)
