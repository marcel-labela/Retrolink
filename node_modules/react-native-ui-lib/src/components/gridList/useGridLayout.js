...
const useGridLayout = props => {
  ...
  const _containerWidth = useMemo(() => {
    return (containerWidth ?? Constants.screenWidth) - listPadding * 2; // eslint-disable-next-line react-hooks/exhaustive-deps
  ...
  const itemWidth = useMemo(() => {
    return (_containerWidth - itemSpacing * (numberOfColumns - 1)) / numberOfColumns; // eslint-disable-next-line react-hooks/exhaustive-deps
